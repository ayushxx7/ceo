...
const projects = [
  ...
  {
    title: 'dotfiles',
    description: 'Linux/macOS configuration files for vim, zsh, tmux, and more. Optimized for productivity and development.',
  ...
  },
  {
    ...
    description: 'A utility tool to batch rename files automatically based on custom rules.',
  ...
  },
  {
    ...
    description: 'Personal blog built with static site generators, featuring articles on machine learning, NLP, and software engineering.',
  ...
  },
  {
    ...
    description: 'My personal website and portfolio, built with Jekyll and GitHub Pages.',
  ...
  },
  {
    ...
    description: 'Deep learning project for gesture recognition using computer vision and neural networks.',
