...
export default function NavBar() {
  ...
  return (
    <nav className="w-full flex justify-center py-2 sm:py-4 md:py-6 z-50 px-2 sm:px-4 relative">
      {/* Desktop Nav */}
      <div className="hidden md:flex flex-wrap justify-center gap-1 sm:gap-2 md:gap-0 font-mono text-green-400 text-xs sm:text-sm md:text-base bg-neutral-900/30 backdrop-blur-sm px-2 sm:px-4 md:px-8 py-1 sm:py-2 overflow-hidden rounded-full" data-menu="true">
        <Link href="/" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd home</Link>
        <span className="text-neutral-700 select-none self-center hidden md:inline">|</span>
        <Link href="/about" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd about</Link>
        <span className="text-neutral-700 select-none self-center hidden md:inline">|</span>
        <Link href="/experience" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd experience</Link>
        <span className="text-neutral-700 select-none self-center hidden md:inline">|</span>
        <Link href="/accomplishments" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd accomplishments</Link>
        <span className="text-neutral-700 select-none self-center hidden md:inline">|</span>
        <Link href="/projects" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd projects</Link>
        <span className="text-neutral-700 select-none self-center hidden md:inline">|</span>
        <Link href="/shelf" className="px-2 sm:px-3 md:px-3 py-1 hover:text-green-200 transition-colors whitespace-nowrap">$ cd digital shelf</Link>
      </div>
