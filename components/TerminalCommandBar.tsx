...
export default function TerminalCommandBar() {
  ...
  return (
    <div className="fixed bottom-30 left-0 w-full z-[100] pointer-events-none">
      <div className="flex items-end justify-center w-full">
        <div className="bg-black/95 border-t border-green-400/30 text-white rounded-t-lg px-4 py-2 shadow-xl shadow-green-400/10 w-full max-w-2xl mx-2 mb-2 pointer-events-auto">
          <div style={{ maxHeight: 140, overflowY: "auto", fontFamily: "monospace", fontSize: "0.95em", marginBottom: 2 }}>
            {output.slice(-5).map((line, idx) => (
              <div key={idx} className="whitespace-pre-line text-green-300">{line}</div>
            ))}
          </div>
          <div className="flex items-center space-x-2 font-mono text-sm">
            ...
            placeholder='Type "ls", "cd about", "cat projects", or page name...'
